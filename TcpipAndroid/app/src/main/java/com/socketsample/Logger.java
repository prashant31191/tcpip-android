...
public class Logger implements ServerListener, ClientListener {
	...
	@Override
	public void clientConnected(Server server, Server.ConnectionToClient ctc) {
		out.println(prefix + "ServerListener" + delimiter + "clientConnected" + suffix + " " + ctc.getClientId());
		out.flush();
	}

	@Override
	public void messageReceived(Server server, Server.ConnectionToClient ctc, Object msg) {
	...
	@Override
	public void commandReceived(Server server, Server.ConnectionToClient ctc, Command cmd) {
	...
	@Override
	public void clientDisconnected(Server server, Server.ConnectionToClient ctc) {
		out.println(prefix + "ServerListener" + delimiter + "clientDisconnected" + suffix + " " + ctc.getClientId());
		out.flush();
	}

	@Override
	public void messageSent(Server server, Server.ConnectionToClient toCtc, Object msg) {
	...
	@Override
	public void commandSent(Server server, Server.ConnectionToClient toCtc, Command cmd) {
