...
import com.quickblox.sample.user.activities.SignInActivity;
...
public class DialogsActivity extends BaseActivity implements DialogsManager.ManagingDialogsCallbacks {
        ...
        if (resultCode == RESULT_OK) {
            ...
            if (requestCode == REQUEST_SELECT_PEOPLE) {
                ...
                if (isPrivateDialogExist(selectedUsers)){
                    ...
                    Logs.showLog(TAG+"=======notification id or other existingPrivateDialog id ==="+ existingPrivateDialog.getDialogId() + "");
    ...
    private void userLogout() {
        ChatHelper.getInstance().logout(new QBEntityCallback<Void>() {
            ...
            public void onSuccess(Void aVoid, Bundle bundle) {
                ...
                SignInActivity.start(DialogsActivity.this);
              //111  demo LoginActivity.start(DialogsActivity.this);
    ...
    public void onMoreClick(View view) {
        ...
        // Open My Group activity
        ActGroupDemo.start(this);
        ...
        dialogsListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (currentActionMode == null) {
                    Logs.showLog(TAG+"=======notification id or other existingPrivateDialog id 584e553da0eb47ed1500001a ==="+ selectedDialog.getDialogId() + "");
                    ChatActivity.startForResult(DialogsActivity.this, REQUEST_DIALOG_ID_FOR_UPDATE, selectedDialog.getDialogId());

                  //  ChatActivity.startForResult(DialogsActivity.this, REQUEST_DIALOG_ID_FOR_UPDATE, "584e4bd3a0eb47f93a00004b");
        ...
        ChatHelper.getInstance().createDialogWithSelectedUsers(selectedUsers,
                new QBEntityCallback<QBChatDialog>() {
                    ...
                    public void onSuccess(QBChatDialog dialog, Bundle args) {
                        ...
                        Logs.showLog(TAG+"=======notification id or other existingPrivateDialog id ==="+ dialog.getDialogId() + "");
